...
#ifndef STUCK_SCENE_CAPTURE_PANEL_HPP_
#define STUCK_SCENE_CAPTURE_PANEL_HPP_
...
class StuckSceneCapturePanel : public rviz_common::Panel
{
  Q_OBJECT

public:
  explicit StuckSceneCapturePanel(QWidget * parent = nullptr);
  ~StuckSceneCapturePanel() override;
  void update();
...
#endif  // STUCK_SCENE_CAPTURE_PANEL_HPP_
